...
import { useGetProjectById } from '../../api/mutation/ProjectMutation';
      ...
      <div className="min-h-screen bg-gray-50 pb-12">
          ...
          <div className="container mx-auto py-8 max-w-5xl">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex gap-3">
                <button className="h-10 px-4 py-2 bg-white text-purple-600 hover:bg-white/90 rounded-md">
                  Apply to Join
                </button>
        ...
        <div className="bg-white border-b">
          <div className="container mx-auto px-4 py-4 flex justify-center">
            <div className="max-w-5xl flex flex-row items-center justify-between w-full">
