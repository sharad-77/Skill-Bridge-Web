          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <textarea
                  rows="4"
                  placeholder="Tell us about your background, experience, and what you're passionate about mentoring..."
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select className="pl-10 pr-3 py-3 h-12 w-full rounded-lg border border-gray-300 bg-white transition-all duration-200 focus:outline-none focus:ring-2 focus:border-purple-500 focus:ring-purple-500">
