  ...
  return (
    <div>
      ...
      <div className="text-left shadow-lg  bg-gradient-to-r from-purple-500 to-blue-500 ">
        <header className="text-[#ffffff] font-semibold p-6 lg:p-10  flex flex-col items-left 2xl:items-center">
          <div className="inline-block bg-black opacity-80 text-white text-sm px-3 p-3 rounded-full mb-3 h-full max-w-fit">
            Collaboration Hub
          </div>
      ...
      <div className="bg-white h-full gap-3 mx-3 px-3 py-2 rounded-lg font-semibold flex items-center justify-center">
